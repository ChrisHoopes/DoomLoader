...
namespace DoomLoader
{
    public class TextureLoader : MonoBehaviour 
    {
        ...
        public Texture GetWallTexture(string textureName)
        {
            ...
            UnityEngine.Debug.Log("TextureLoader: No wall texture \"" + textureName +"\"");
            return illegal;
        }
        ...
        public Texture GetFlatTexture(string textureName)
        {
            ...
            UnityEngine.Debug.Log("TextureLoader: No flat texture \"" + textureName + "\"");
            return illegal;
        }
        ...
        public Texture GetSpriteTexture(string textureName)
        {
            ...
            UnityEngine.Debug.Log("TextureLoader: No sprite texture \"" + textureName + "\"");
            return illegal;
        }
        ...
        public void BuildWallTextures()
        {
            foreach (MapTexture t in MapTextures)
            {
                ...
                foreach (MapPatch p in t.patches)
                {
                    ...
                    {
                        UnityEngine.Debug.LogError("TextureLoader: BuildTextures: Patch number out of range, in texture \"" + t.textureName + "\"");
                        continue;
                    }
                    ...
                    {
                        UnityEngine.Debug.LogError("TextureLoader: BuildTextures: Could not find patch \"" + patchName + "\"");
                        continue;
                    }

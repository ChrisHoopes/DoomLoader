...
namespace DoomLoader
{
    public struct Line2D
    {
        ...
        // Constructor
        public Line2D(Vector2 v1, float x2, float y2)
        {
            this.v1 = v1;
        ...
        // Constructor
        public Line2D(float x1, float y1, Vector2 v2)
        {
        ...
        public static Vector2 GetNormal(float dx, float dy)
        {
        ...
        public static bool GetIntersection(Vector2 v1, Vector2 v2, float x3, float y3, float x4, float y4)
        {
            float u_ray, u_line;
        ...
        // This tests if the line intersects with the given line coordinates
        public static bool GetIntersection(Vector2 v1, Vector2 v2, float x3, float y3, float x4, float y4, out float u_ray)
        {
            float u_line;
        ...
        public static bool GetIntersection(Vector2 v1, Vector2 v2, float x3, float y3, float x4, float y4, out float u_ray, bool bounded)
        {
            float u_line;
        ...
        public static Vector2 GetIntersectionPoint(Line2D line1, Line2D line2, bool bounded)
        {
            float u_ray, u_line;
        ...
        // This tests if the line intersects with the given line coordinates
        public static bool GetIntersection(Vector2 v1, Vector2 v2, float x3, float y3, float x4, float y4, out float u_ray, out float u_line)
        {
            return GetIntersection(v1, v2, x3, y3, x4, y4, out u_ray, out u_line, true);
        }

        // This tests if the line intersects with the given line coordinates
        public static bool GetIntersection(Vector2 v1, Vector2 v2, float x3, float y3, float x4, float y4, out float u_ray, out float u_line, bool bounded)
        {
            // Calculate divider
        ...
        public static float GetSideOfLine(Vector2 v1, Vector2 v2, Vector2 p)
        {
        ...
        public static float GetDistanceToLine(Vector2 v1, Vector2 v2, Vector2 p, bool bounded)
        {
            return (float)Math.Sqrt(GetDistanceToLineSq(v1, v2, p, bounded));
        }

        // This returns the shortest distance from given coordinates to line
        public static float GetDistanceToLineSq(Vector2 v1, Vector2 v2, Vector2 p, bool bounded)
        {
        ...
        public static float GetNearestOnLine(Vector2 v1, Vector2 v2, Vector2 p)
        {
        ...
        public static Vector2 GetCoordinatesAt(Vector2 v1, Vector2 v2, float u)
        {
            // Calculate and return intersection offset
            return new Vector2(v1.x + u * (v2.x - v1.x), v1.y + u * (v2.y - v1.y));
        }
        ...
        public Vector2 GetDelta() { return v2 - v1; }
        ...
        public float GetSideOfLine(Vector2 p)
        {
            return Line2D.GetSideOfLine(v1, v2, p);
        }

        public float GetDistanceToLine(Vector2 p, bool bounded)
        {

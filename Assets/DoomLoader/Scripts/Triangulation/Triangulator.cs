...
namespace DoomLoader
{
    public class Triangulator
    {
        ...
        public static List<Vector2> vertices;
        ...
        private int DoEarClip(EarClipPolygon poly, List<Vector2> verticeslist, List<Sidedef> sidedefslist)
        {
            ...
            do
            {
                ...
                Vector2 d = n1.Value.Position - n2.Value.Position;
...
/*#if DEBUG
        ...
        {
            //mxd
            Vector2 pos0 = t[0].Position;
            Vector2 pos1 = t[1].Position;
            Vector2 pos2 = t[2].Position;
            Vector2 vpos;
        ...
        private static bool LineInsideTriangle(EarClipVertex[] t, Vector2 p1, Vector2 p2)
        {
        ...
        {
            Vector2 tp0 = t[0].Position;
            Vector2 tp1 = t[1].Position;
            Vector2 tp2 = t[2].Position;
        ...
        private static void AddTriangleToList(EarClipVertex[] triangle, List<Vector2> verticeslist, List<Sidedef> sidedefslist, bool last)
        {
            //mxd

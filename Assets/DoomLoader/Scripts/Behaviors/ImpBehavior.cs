...
{
    public class ImpBehavior : BehaviorBase
    {
        ...
        const int MeleeDamageMin = 3;
        const int MeleeDamageMax = 24;
        ...
        public override void Init()
        {
            ...
            if (mc == null)
                UnityEngine.Debug.LogError("ImpBehavior: Init: Could not get component \"MonsterController\" from owner \"" + owner.thingName + "\"");
